...
extension UINavigationController {
	@objc override func willShowingViewControllerPushWithSender(_ sender: AnyObject?) -> Bool {
...
extension UISplitViewController {
	...
	@objc override func willShowingDetailViewControllerPushWithSender(_ sender: AnyObject?) -> Bool {
        if isCollapsed {
            /*
