...
extension UIViewController {
    ...
    */
    @objc func containedPhoto() -> Photo? {
        // By default, view controllers don't contain photos.
        return nil
    }
    
    @objc func containsPhoto(_ photo: Photo) -> Bool {
        // By default, view controllers don't contain photos.
        return false
    }
...
extension UISplitViewController {
	@objc override func currentVisibleDetailPhotoWithSender(_ sender: AnyObject?) -> Photo? {
        if isCollapsed {
